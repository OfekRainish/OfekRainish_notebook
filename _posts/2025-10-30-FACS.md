...
## Results
![](../images/FACS/used%20facs/flowJO/8-24.png)
![](../images/FACS/used%20facs/flowJO/28-42.png)

Unfortunately, I did not include time point 0 in this test. Therefore, I had to repeat the experiment for this time point (25.11.25). The experiment was performed as described above (1000-fold dilution through 2 Eppendorf tubes + 40 micron filtration).
Together with this time point, I was able to construct graphs that describe the change in parameters (FSC - H, SSC -H, counts and florecence) over the sampled time points.

It is important to note and take into account when interpreting the results:
1. There may be a batch effect between time point 0 and the other time points in the experiment.
2. It is important to note that in this experiment and in these graphs we used standard error and not standard deviation.

![](../images/FACS/used%20facs/graphs/counts.png)
![](../images/FACS/used%20facs/graphs/fsc.png)
![](../images/FACS/used%20facs/graphs/ssc.png)
![](../images/FACS/used%20facs/graphs/SG.png)

It is interesting to see the SSC graph. At first we see high complexity in the bacterial cells exposed to surfactin, which may correspond to the growth inhibition (which we see in both the FACS results and the plate reader experiment). It is possible that at this stage the bacteria are preparing all the machinery they need to deal with surfactin.

Acquisition parameters: 20,000 events recorded per sample, maximum acquisition time of 600 s, volume of 10 μL, in a sample flow rate of 10 μL/min.